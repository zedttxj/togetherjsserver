...
async function runAuthenticatedClient(hubUrl = "wss://relay-h2hg.onrender.com/hub", certificate, privateKey, caPublicKey, roomId) {
  return new Promise((resolve, reject) => {
    try {
...
async function runAuthenticatedClient2Ways(hubUrl = "wss://relay-h2hg.onrender.com/hub", certificate, privateKey, caPublicKey, roomId) {
  return new Promise((resolve, reject) => {
    try {
